...
const SAMPLE_STAFF_ROSTER: StaffRow[] = [
  ...
  },
  {
    ...
    role: 'Senior Carer',
    visits: [
      { id: 'v1', patientName: 'Sarah J.', startHour: 8, duration: 1, color: '#1a86f0', type: 'medication', status: 'completed' },
      { id: 'v2', patientName: 'John M.', startHour: 10, duration: 1.5, color: '#7c6df0', type: 'personal care', status: 'scheduled' },
      { id: 'v3', patientName: 'Alice P.', startHour: 14, duration: 1, color: '#1a86f0', type: 'check-in', status: 'scheduled' },
    ]
  },
  {
    id: '2',
    ...
    visits: [
      ...
      { id: 'v5', patientName: 'Robert K.', startHour: 9, duration: 1, color: '#1a86f0', type: 'medication', status: 'in-progress' },
  ...
  },
  {
    ...
    visits: [
      ...
      { id: 'v11', patientName: 'Susan K.', startHour: 13, duration: 1, color: '#1a86f0', type: 'medication', status: 'scheduled' },
  ...
  },
  {
    ...
    visits: [
      ...
      { id: 'v14', patientName: 'William H.', startHour: 12, duration: 1, color: '#1a86f0', type: 'medication', status: 'scheduled' },
  ...
  return (
    <div className="h-full flex flex-col bg-[#F4F6F8]" style={{ userSelect: dragState.isDragging ? 'none' : 'auto', cursor: dragState.isDragging ? 'grabbing' : 'auto' }}>
      ...
      <div className="p-6 space-y-4 flex-1 flex flex-col min-h-0">
        ...
        <div className="bg-white px-4 py-3 border border-[rgba(20,30,60,0.08)] rounded-lg shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <CalendarIcon className="w-5 h-5 text-[#1a86f0]" />
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-[#1a86f0] text-white rounded-lg text-sm font-medium hover:bg-blue-600 shadow-sm">
        ...
        <div className="bg-[#e5e7eb] px-4 py-2 flex items-center justify-between rounded-lg">
          ...
          <div className="flex items-center gap-3">
            <button className="px-3 py-1 text-xs font-medium text-[#1a86f0] bg-blue-50 rounded hover:bg-blue-100">
              Today
            </button>
        ...
        {/* Roster Content */}
        {viewMode === 'daily' ? (
          <div className="flex-1 flex border border-[rgba(20,30,60,0.08)] rounded-lg overflow-hidden bg-white shadow-sm">
            {/* Staff Column */}
                  ...
                  >
                    <div className="flex items-center gap-3 w-full">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 ${
                        staff.id === 'unallocated' ? 'bg-red-500' : 'bg-[#1a86f0]'
                      }`}>
                        {staff.avatar}
                      </div>
                    ...
                    >
                      ...
                      {staff.visits.map((visit) => {
                        ...
                        return (
                          <div
                            key={visit.id}
                            className="absolute top-2 h-16 rounded-lg shadow-sm cursor-move hover:shadow-lg hover:scale-[1.02] transition-all z-10"
                            style={{
                              left: `${leftPx}px`,
                              width: `${Math.max(widthPx, 100)}px`,
                          ...
                          >
                            <div className="flex items-center h-full px-2 gap-1.5">
                              ...
                              <div className="flex items-center gap-1 bg-white/25 rounded px-1.5 py-0.5 flex-shrink-0">
          ...
          /* Weekly View */
          <div className="flex-1 bg-white rounded-lg border border-[rgba(20,30,60,0.08)] overflow-auto shadow-sm">
            {/* Week Header */}
                    ...
                    <div className="space-y-1">
                      {staff.visits
                        ...
                        .map((visit) => (
                          <div
                            key={visit.id}
                            className="rounded px-2 py-1.5 cursor-pointer hover:shadow-md transition-shadow"
                            style={{
                              backgroundColor: visit.status === 'completed' ? '#10b981' :
                                              visit.status === 'in-progress' ? '#3b82f6' :
                                              visit.color,
